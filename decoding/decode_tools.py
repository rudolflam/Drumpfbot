...
from decode_utils import load_params, init_tparams
from decode_model import init_params, build_sampler
from decode_search import gen_sample


def load_model(path_to_model = 'decode_model.npz', path_to_dictionary = 'social_media.pkl'):
    """
